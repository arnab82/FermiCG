...
# end
# ept2 = FermiCG.compute_pt2_energy(v_tpsci, cluster_ops, clustered_ham, thresh_foi=1e-8)
# @printf("\n TPSCI+PT2:\n")
# for r in 1:nroots
#     @printf(" %5i  %14.8f\n", r, e_tpsci[r]+ept2[r])
# end
...
println("\n Running CEPA-0 [solver=:minres, build_hqq=:sparse]  thresh_foi=$thresh_foi_cepa ...")
GC.gc()
r_sparse_s_1e8 = @timed FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
                                           cepa_shift="cepa", thresh_foi=thresh_foi_cepa,
...
println("\n Running CEPA-0 [solver=:minres, build_hqq=:sparse]  thresh_foi=$thresh_foi_cepa ...")
GC.gc()
r_sparse_s_1e6 = @timed FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
                                           cepa_shift="cepa", thresh_foi=thresh_foi_cepa,
...
# println("\n Running CEPA-0 [solver=:minres, build_hqq=:sparse]  thresh_foi=$thresh_foi_cepa ...")
# GC.gc()
# r_sparse_s1 = @timed FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                            cepa_shift="cepa", thresh_foi=thresh_foi_cepa,
#                                            nbody=4, tol=1e-8, solver=:minres,
#                                            build_hqq=:sparse, verbose=0)
# println("time taken: ", r_sparse_s1.time, " seconds")
# println("\n Running ACPF [solver=:minres, build_hqq=:sparse] ...")
# @time e_acpf1 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="acpf", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)

# println("\n Running AQCC [solver=:minres, build_hqq=:sparse] ...")
# @time e_aqcc1 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="aqcc", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)
# println("\n Running CEPA-0 [solver=:minres, build_hqq=:sparse]  thresh_foi=$thresh_foi_cepa ...")
...
# r_sparse_s2 = @timed FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                         cepa_shift="cepa", thresh_foi=thresh_foi_cepa,
#                                         nbody=4, tol=1e-8, solver=:minres,
#                                         build_hqq=:sparse, verbose=0)
# println("\n Running ACPF [solver=:minres, build_hqq=:sparse] ...")
# @time e_acpf2 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="acpf", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)

# println("\n Running AQCC [solver=:minres, build_hqq=:sparse] ...")
# @time e_aqcc2 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="aqcc", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)
...
# r_sparse_s3 = @timed FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                         cepa_shift="cepa", thresh_foi=thresh_foi_cepa,
#                                         nbody=4, tol=1e-8, solver=:minres,
#                                         build_hqq=:sparse, verbose=0)
# println("\n Running ACPF [solver=:minres, build_hqq=:sparse] ...")
# @time e_acpf4 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="acpf", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)

# println("\n Running AQCC [solver=:minres, build_hqq=:sparse] ...")
# @time e_aqcc4 = FermiCG.do_fois_cepa(ci_vector, cluster_ops, clustered_ham,
#                                       cepa_shift="aqcc", thresh_foi=thresh_foi_cepa,
#                                       nbody=4, tol=1e-8, solver=:minres,
#                                       build_hqq=:sparse, verbose=0)                                      
# println()
