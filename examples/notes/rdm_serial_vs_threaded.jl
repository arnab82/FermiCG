...
ci_vec   = FermiCG.TPSCIstate(clusters, ref_fock, R=nroots, T=Float64)
...
e0, v0 = FermiCG.tpsci_ci(ci_vec, cluster_ops, clustered_ham,
...
γ_aa_s, γ_bb_s = FermiCG.compute_1rdm(v0, cluster_ops)
γ_aa_t, γ_bb_t = FermiCG.compute_1rdm_threaded(v0, cluster_ops)
...
println("\n  Timing:")
print("  serial:   "); @time FermiCG.compute_1rdm(v0, cluster_ops)
print("  threaded: "); @time FermiCG.compute_1rdm_threaded(v0, cluster_ops)
...
γ_ab_s, γ_ba_s = FermiCG.compute_1rdm_sf(v0, cluster_ops)
γ_ab_t, γ_ba_t = FermiCG.compute_1rdm_sf_threaded(v0, cluster_ops)
...
println("\n  Timing:")
print("  serial:   "); @time FermiCG.compute_1rdm_sf(v0, cluster_ops)
print("  threaded: "); @time FermiCG.compute_1rdm_sf_threaded(v0, cluster_ops)
