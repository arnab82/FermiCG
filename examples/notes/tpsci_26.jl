...
#=
let
    cluster_bases = FermiCG.compute_cluster_eigenbasis_spin(ints, clusters, d1, [5,5,5], init_fspace, max_roots=M, verbose=1);
...
FermiCG.add_fockconfig!(ci_vector, FockConfig([(2, 5), (3, 3), (5, 2)]))
# M_S = 0 CT sectors
FermiCG.add_fockconfig!(ci_vector, FockConfig([(4, 2), (3, 3), (3, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (2, 3), (3, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 3), (3, 3), (2, 4)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 3), (3, 2), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(4, 3), (3, 3), (3, 4)]))
ci_vector = FermiCG.add_spin_focksectors(ci_vector)
# M_S = +1  (needed for non-zero SOC_+)
FermiCG.add_fockconfig!(ci_vector, FockConfig([(6, 1), (3, 3), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (4, 2), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (3, 3), (3, 4)]))
# M_S = -1  (needed for non-zero SOC_-)
FermiCG.add_fockconfig!(ci_vector, FockConfig([(4, 3), (3, 3), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (2, 4), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (3, 3), (1, 6)]))
# M_S = +2
FermiCG.add_fockconfig!(ci_vector, FockConfig([(6, 1), (3, 3), (3, 4)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(6, 1), (4, 2), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (4, 2), (3, 4)]))
# M_S = -2
FermiCG.add_fockconfig!(ci_vector, FockConfig([(4, 3), (3, 3), (1, 6)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(4, 3), (2, 4), (2, 5)]))
FermiCG.add_fockconfig!(ci_vector, FockConfig([(5, 2), (2, 4), (1, 6)]))

fspace_0 = init_fspace

# M_S = 0 CT via FermiCG.replace
tmp_fspace = FermiCG.replace(fspace_0, (1,3), ([4,2],[3,5]))   # α: C1→C3
FermiCG.add_fockconfig!(ci_vector, tmp_fspace)
ci_vector[tmp_fspace][FermiCG.ClusterConfig([1,1,1])] = zeros(Float64, nroots)

tmp_fspace = FermiCG.replace(fspace_0, (2,3), ([2,3],[3,5]))   # α: C2→C3
FermiCG.add_fockconfig!(ci_vector, tmp_fspace)
ci_vector[tmp_fspace][FermiCG.ClusterConfig([1,1,1])] = zeros(Float64, nroots)

tmp_fspace = FermiCG.replace(fspace_0, (1,3), ([5,3],[2,4]))   # β: C3→C1
FermiCG.add_fockconfig!(ci_vector, tmp_fspace)
ci_vector[tmp_fspace][FermiCG.ClusterConfig([1,1,1])] = zeros(Float64, nroots)

tmp_fspace = FermiCG.replace(fspace_0, (1,2), ([5,3],[3,2]))   # β: C2→C1
FermiCG.add_fockconfig!(ci_vector, tmp_fspace)
ci_vector[tmp_fspace][FermiCG.ClusterConfig([1,1,1])] = zeros(Float64, nroots)

tmp_fspace = FermiCG.replace(fspace_0, (1,3), ([4,3],[3,4]))   # spin-exchange C1↔C3
FermiCG.add_fockconfig!(ci_vector, tmp_fspace)
ci_vector[tmp_fspace][FermiCG.ClusterConfig([1,1,1])] = zeros(Float64, nroots)
